...
const loadData = async () => {
  loading.value = true
  try {
    const res = await getCustomers({ page: pagination.page, page_size: pagination.pageSize })
...
const handleAdd = () => {
  Object.assign(form, { id: null, code: '', name: '', contact: '', phone: '', credit_limit: 0, address: '', status: 1 })
